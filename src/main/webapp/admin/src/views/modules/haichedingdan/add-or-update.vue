  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.haicheshijian" label="还车时间" prop="haicheshijian">
              <el-input v-model="ruleForm.haicheshijian" 
                placeholder="还车时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="归还位置" prop="guihaiweizhi">
          <el-input v-model="ruleForm.guihaiweizhi" 
              placeholder="归还位置" clearable  :readonly="ro.guihaiweizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="归还位置" prop="guihaiweizhi">
              <el-input v-model="ruleForm.guihaiweizhi" 
                placeholder="归还位置" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.haicheshijian = true;
            continue;
	            	            ...
	            	            if(o=='guihaiweizhi'){
            this.ruleForm.guihaiweizhi = obj[o];
	    this.ro.guihaiweizhi = true;
            continue;
          }
	            	            if(o=='yonghuzhanghao'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `haichedingdan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.haichedingdanCrossAddOrUpdateFlag = false;
                  this.parent.search();
