  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="租赁编号" prop="zulinbianhao">
              <el-input v-model="ruleForm.zulinbianhao" 
                placeholder="租赁编号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="单车编号" prop="danchebianhao">
          <el-input v-model="ruleForm.danchebianhao" 
              placeholder="单车编号" clearable  :readonly="ro.danchebianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="单车编号" prop="danchebianhao">
              <el-input v-model="ruleForm.danchebianhao" 
          ...
          <el-form-item class="input" label="押金" prop="yajin">
              <el-input v-model="ruleForm.yajin" 
                placeholder="押金" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否超时" prop="shifouchaoshi">
          <el-select v-model="ruleForm.shifouchaoshi" placeholder="请选择是否超时">
            <el-option
                v-for="(item,index) in shifouchaoshiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="是否超时" prop="shifouchaoshi">
	      <el-input v-model="ruleForm.shifouchaoshi"
                placeholder="是否超时" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="租赁费用" prop="zulinfeiyong">
          <el-input v-model="ruleForm.zulinfeiyong" 
              placeholder="租赁费用" clearable  :readonly="ro.zulinfeiyong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="租赁费用" prop="zulinfeiyong">
              <el-input v-model="ruleForm.zulinfeiyong" 
                placeholder="租赁费用" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="超时费用" prop="chaoshifeiyong">
          <el-input v-model="ruleForm.chaoshifeiyong" 
              placeholder="超时费用" clearable  :readonly="ro.chaoshifeiyong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="超时费用" prop="chaoshifeiyong">
              <el-input v-model="ruleForm.chaoshifeiyong" 
                placeholder="超时费用" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  computed: {
                                                                                        zongfeiyong: {
                                                                                                                                                                                                                                                                                                    get: function () {
        return 0+parseFloat(this.ruleForm.zulinfeiyong)+parseFloat(this.ruleForm.chaoshifeiyong) || ''
      }
    },
                                                                      },
  created() {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yajin = true;
            continue;
	            	            ...
	            	            if(o=='shifouchaoshi'){
            this.ruleForm.shifouchaoshi = obj[o];
	    this.ro.shifouchaoshi = true;
            continue;
          }
	            	            if(o=='zulinfeiyong'){
	    ...
	    this.ro.zulinfeiyong = true;
            continue;
	            	            ...
	            	            if(o=='chaoshifeiyong'){
            this.ruleForm.chaoshifeiyong = obj[o];
	    this.ro.chaoshifeiyong = true;
            continue;
          }
	            	            if(o=='zongfeiyong'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                ...
                                                                                                this.shifouchaoshiOptions = "否,是".split(',')
                                                                                                                                                                            },
                                                                                                        // 多级联动参数
                                                                                                                                    info(id) {
      this.$http({
        url: `zulinfeiyong/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `zulinfeiyong/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zulinfeiyongCrossAddOrUpdateFlag = false;
                  this.parent.search();
