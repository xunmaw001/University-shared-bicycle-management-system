<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="停放车辆" prop="tingfangcheliang">
          <el-input v-model="ruleForm.tingfangcheliang" 
              placeholder="停放车辆" clearable  :readonly="ro.tingfangcheliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="停放车辆" prop="tingfangcheliang">
              <el-input v-model="ruleForm.tingfangcheliang" 
                placeholder="停放车辆" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="区域位置" prop="quyuweizhi">
          <el-input v-model="ruleForm.quyuweizhi" 
              placeholder="区域位置" clearable  :readonly="ro.quyuweizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="区域位置" prop="quyuweizhi">
              <el-input v-model="ruleForm.quyuweizhi" 
                placeholder="区域位置" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='tingfangcheliang'){
            this.ruleForm.tingfangcheliang = obj[o];
	    this.ro.tingfangcheliang = true;
            continue;
          }
	            	            if(o=='quyuweizhi'){
            this.ruleForm.quyuweizhi = obj[o];
	    this.ro.quyuweizhi = true;
            continue;
          }
	            	            if(o=='beizhu'){
